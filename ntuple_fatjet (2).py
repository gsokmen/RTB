...
def main():
    ...
    hists["fatjet_efficiency2D"] = create2Dmap("fatjet_efficiency2D", params, "fatjet_efficiency", dumptcl)
...
#            jetParFlav = findPartonFlav(genparts, pVec, params['dR'])
            ...
            hists["fatjet_efficiency2D"].Fill(p.pt(), p.eta(), isTagged)
